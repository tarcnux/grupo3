...
public class EntityManagerProvider {
     ...
     * Custo 'muito alto' para você instanciá-lo o tempo todo
     */
     ...
     * * EntityManager:
     *
     * Mapeia e gerencia um conjunto de classes a um banco de dados;
     * Este conjunto de classes é chamado de PERSISTENCE UNIT.
     *
